        ...
        <div class="pos-content-container h-100">
            <div class="row gx-4">
                @foreach($products as $product)
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 pb-4 product-item" data-type="cat-{{ $product->product_category_id }}" data-category-id="{{ $product->product_category_id }}">
